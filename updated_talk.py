...
def user_chatbot_conversation():
    ...
    while True:
        ...
        audio_file_pth2 = "C:/Users/Owner/Documents/GitHub/Local-Low-Latency-Speech-to-Speech/outputs"
...
def transcribe_multiple_files(file_paths):
    with multiprocessing.Pool(processes=multiprocessing.cpu_count()) as pool:
        results = pool.map(transcribe_with_whisper, file_paths)
    return results

# Example usage
if __name__ == "__main__":
    # Placeholder list of audio files to be transcribed
    # Replace these with the actual file paths
    audio_files = ['path_to_audio1.wav', 'path_to_audio2.wav', 'path_to_audio3.wav']
    transcriptions = transcribe_multiple_files(audio_files)
